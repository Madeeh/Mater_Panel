...
public class AddPriceListWashAndIron extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_price_list_wash_and_iron);
        ...
        ProductsRef.child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Intent intent = new Intent(AddPriceListWashAndIron.this, AdminCategory.class);
                        startActivity(intent);

                        loadingBar.dismiss();
                        Toast.makeText(AddPriceListWashAndIron.this, "Product is added successfully..", Toast.LENGTH_SHORT).show();
                    } else {
                        loadingBar.dismiss();
                        String message = task.getException().toString();
                        Toast.makeText(AddPriceListWashAndIron.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                    }
                });
    }
}