...
public class AddPriceListIron extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_price_list_iron);

        ProductsRef = FirebaseDatabase.getInstance().getReference().child("PriceList").child("Iron");
        ...
        ProductsRef.child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Intent intent = new Intent(AddPriceListIron.this, AdminCategory.class);
                        startActivity(intent);

                        loadingBar.dismiss();
                        Toast.makeText(AddPriceListIron.this, "Product is added successfully..", Toast.LENGTH_SHORT).show();
                    } else {
                        loadingBar.dismiss();
                        String message = task.getException().toString();
                        Toast.makeText(AddPriceListIron.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                    }
                });
