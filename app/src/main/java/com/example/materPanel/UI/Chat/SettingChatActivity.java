                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    UsersChat usersChat = new UsersChat(auth.getUid(), name, email, finalImageUri, status);
                                    ...
                                    reference.setValue(usersChat).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                Toast.makeText(SettingChatActivity.this, "Data Successfully Updated", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(SettingChatActivity.this, HomeChatActivity.class));
                                            } else {
                                                progressDialog.dismiss();

                                                Toast.makeText(SettingChatActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                }
